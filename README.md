This project is a FastAPI application that provides CRUD (Create, Read, Update, Delete) operations for managing a book directory. It uses PostgreSQL as the database to store book information.
